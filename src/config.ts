...
/**
 * The UpassistRUM script configuration object.
 */
export interface UpassistRUMConfig {
  /**
   * Your site's client key.
   */
  clientKey?: string;
  /**
   * The environment for which you want to send events to. Unless provided, will use the Upassist account default environment.
   */
  environment?: string;
  /**
   ...
   */
  beforeSend?: (payload: UpassistRUMEvent) => UpassistRUMEvent | undefined;
  /**
...
export const setConfig = (params: Partial<UpassistRUMConfig>) => {
